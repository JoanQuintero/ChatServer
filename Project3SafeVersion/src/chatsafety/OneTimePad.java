...
public class OneTimePad {
	...
	protected String encrypt() {
		...
		for(int i=0; i<plainMessage.length(); i++) {
			...
			//System.out.println("hehehe encrypted message is "+encryptedMessage); //debugging
	...
	protected String decrypt() {
		...
		for(int i=0; i<encrMessage.length(); i++) {
			...
			//System.out.println("hehehe encrypted message is "+decryptedMessage); //debugging
	...
	public static void main(String [] args) {
		OneTimePad otp = new OneTimePad("abvdefghijklmnopqrstuvwxyz");
